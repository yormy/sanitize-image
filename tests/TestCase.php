...
use Yormy\SanitizeImage\Http\Middleware\ReferrerMiddleware;
use Yormy\SanitizeImage\SanitizeImageServiceProvider;
...
//            fn (string $modelName) => 'Yormy\\SanitizeImage\\Database\\Factories\\' . class_basename($modelName) . 'Factory'
//        );
        ...
        Route::middleware(ReferrerMiddleware::class)
            ->group(function () {
                Route::SanitizeImageUser($this->prefix);
                Route::SanitizeImageAdmin($this->prefix);
            });
    ...
    {
        config(['sanitize-image.models.referrer.public_id' => 'id']);

        config(['sanitize-image.models.referrer.class' => User::class]);
    }
    ...
    {
        return [
            SanitizeImageServiceProvider::class,
        ];
    }
